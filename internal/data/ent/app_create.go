...
func (ac *AppCreate) SetBundleID(s string) *AppCreate {
	ac.mutation.SetBundleID(s)
	return ac
}
...
func (ac *AppCreate) SetLatestVersion(s string) *AppCreate {
	ac.mutation.SetLatestVersion(s)
	return ac
}

// SetNillableLatestVersion sets the "latest_version" field if the given value is not nil.
func (ac *AppCreate) SetNillableLatestVersion(s *string) *AppCreate {
	if s != nil {
		ac.SetLatestVersion(*s)
	}
	return ac
}
...
func (ac *AppCreate) AddUserIDs(ids ...int) *AppCreate {
...
func (ac *AppCreate) check() error {
	if _, ok := ac.mutation.BundleID(); !ok {
		return &ValidationError{Name: "bundle_id", err: errors.New(`ent: missing required field "App.bundle_id"`)}
	}
	...
	if _, ok := ac.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "createdAt", err: errors.New(`ent: missing required field "App.createdAt"`)}
	}
	if _, ok := ac.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updatedAt", err: errors.New(`ent: missing required field "App.updatedAt"`)}
	}
	return nil
}
...
func (ac *AppCreate) createSpec() (*App, *sqlgraph.CreateSpec) {
	...
	if value, ok := ac.mutation.BundleID(); ok {
	...
	if value, ok := ac.mutation.LatestVersion(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
