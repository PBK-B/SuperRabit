...
// was not loaded in eager-loading.
func (e UserEdges) VersionsOrErr() ([]*Version, error) {
	if e.loadedTypes[1] {
...
func (*User) scanValues(columns []string) ([]interface{}, error) {
	...
	for i := range columns {
		...
		case user.FieldName, user.FieldEmail, user.FieldPassword, user.FieldToken:
...
func (u *User) QueryApps() *AppQuery {
	return (&UserClient{config: u.config}).QueryApps(u)
}

// QueryVersions queries the "versions" edge of the User entity.
func (u *User) QueryVersions() *VersionQuery {
	return (&UserClient{config: u.config}).QueryVersions(u)
}
